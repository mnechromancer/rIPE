...
class TestKnownAdaptations:
    ...
    def test_tibetan_pika_hemoglobin_adaptation(self, validation_data):
        ...
        print(
            f"✅ Tibetan pika hemoglobin adaptation validated: "
    ...
    @pytest.mark.validation
    def test_hematocrit_altitude_correlation(
        self, high_altitude_environment, sea_level_environment
    ):
        ...
        sea_level_result = engine.simulate(
            environment=sea_level_environment, population_size=500, generations=50
        )

        # Simulate at high altitude
        altitude_result = engine.simulate(
            environment=high_altitude_environment, population_size=500, generations=50
        )

        sea_level_hematocrit = sea_level_result.get("traits", {}).get(
            "hematocrit", 0.42
        )
    ...
    def test_evolutionary_convergence(self):
        ...
        heart_masses = [
            r.get("traits", {}).get("heart_mass_ratio", 0.006) for r in results
        ]
    ...
    def test_fitness_landscape_consistency(self):
        ...
        ), "Altitude-adapted should outperform poorly-adapted"

        print(
            f"✅ Fitness landscape validated: "
