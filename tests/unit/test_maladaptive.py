...
class TestMaladaptiveDetector:
    ...
    def test_detect_with_custom_environments(self):
        ...
        responses = detector.detect_maladaptive_responses(
            norm, environments=custom_envs
        )
    ...
    def test_compare_plastic_vs_constitutive(self):
        ...
        comparison = detector.compare_plastic_vs_constitutive(
            norm, constitutive_phenotype
        )
        ...
        assert len(comparison["plastic_fitness_by_env"]) == len(
    ...
    def test_identify_maladaptive_environments(self):
        ...
        envs = detector.identify_maladaptive_environments(
            maladaptive_norm, threshold=0.01
        )
        ...
        envs_strict = detector.identify_maladaptive_environments(
            maladaptive_norm, threshold=0.5
        )
...
class TestMaladaptationIntegration:
    ...
    def test_comparison_adaptive_vs_maladaptive(self):
        ...
        assert (
            maladaptive_metrics["mean_fitness_cost"]
            >= adaptive_metrics["mean_fitness_cost"]
        )
        assert (
            maladaptive_metrics["proportion_maladaptive"]
    ...
    def test_perfect_adaptation(self):
        ...
        perfect_norm = ReactionNorm(
            [0, 10, 20, 30, 40], [0, 10, 20, 30, 40], "size", "temperature"
        )
