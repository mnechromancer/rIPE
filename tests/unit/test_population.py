...
class TestIndividual:
    ...
    def test_with_genetic_values(self):
        ...
        individual = Individual(
            id=1, physiological_state=state, fitness=0.8, genetic_values=genetic_values
        )
...
class TestPopulation:
    ...
    def test_fitness_statistics(self, basic_population):
        ...
        assert basic_population.get_fitness_variance() == pytest.approx(
            0.0825, rel=1e-3
        )
