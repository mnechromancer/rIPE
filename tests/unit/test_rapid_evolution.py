...
class TestEnvironmentalChange:
    ...
    def sample_environments(self):
        ...
        initial = PhysiologicalState(
            po2=20.0, temperature=15.0, altitude=100.0, salinity=35.0
        )
        final = PhysiologicalState(
            po2=18.0, temperature=25.0, altitude=100.0, salinity=0.0
        )
...
class TestRapidEvolutionSimulator:
    ...
    def test_simulate_constant_environment(self, basic_simulator):
        ...
        results = list(
            basic_simulator.simulate_constant_environment(environment, generations=3)
        )
    ...
    def test_simulate_environmental_change(self, basic_simulator):
        ...
        np.random.seed(42)
        results = list(
            basic_simulator.simulate_environmental_change(scenario, total_generations=3)
        )
...
class TestPredefinedScenarios:
    ...
    def test_altitude_adaptation_scenario(self):
        ...
        assert (
            scenario.initial_environment.po2 > scenario.final_environment.po2
...
class TestContemporaryEvolutionModel:
    ...
    def test_invasion_fitness_function(self):
        ...
        state = PhysiologicalState(
            po2=19.0, temperature=20.0, altitude=0.0, salinity=35.0
        )
        individual = Individual(id=1, physiological_state=state)
        environment = PhysiologicalState(
            po2=19.0, temperature=20.0, altitude=0.0, salinity=10.0
        )
...
class TestExperimentalEvolutionModel:
    ...
    def test_create_selection_experiment(self):
        ...
        model = ExperimentalEvolutionModel.create_selection_experiment(
            trait_target=target_value, population_size=100
        )
        ...
        individual = Individual(
            id=1, physiological_state=state, genetic_values={"cardio1": 0.5}
        )
...
class TestPredefinedScenarioLibrary:
    ...
    def test_urban_heat_island_scenario(self):
        ...
        assert (
            uhi.initial_environment.po2 > uhi.final_environment.po2
        )  # Pollution effect
...
class TestIntegrationRapidEvolution:
    ...
    def test_end_to_end_simulation(self):
        ...
        np.random.seed(42)
        results = list(
            model.simulate_environmental_change(urban_scenario, total_generations=5)
        )
