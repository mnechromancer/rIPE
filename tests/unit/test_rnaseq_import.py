...
class TestRNASeqImporter:
    ...
    def create_expression_matrix(self, filename="expression_matrix.csv", 
                                n_genes=10, n_samples=6):
...
class TestDESeqParser:
    ...
    def create_gsea_results(self, filename="gsea_results.tsv"):
        ...
        data = {
            ...
            'LEADING EDGE': ['Gene1,Gene2,Gene3', 'Gene4,Gene5', 'Gene6,Gene7,Gene8,Gene9']
        }
    ...
    def create_david_results(self, filename="david_results.tsv"):
        ...
        data = {
            ...
            'Term': ['GO:0006412~translation', 'mmu04110:Cell cycle', 'GO:0003824~catalytic activity'],
            'Count': [15, 8, 20],
    ...
    def test_contrast_comparison(self):
        ...
        from ipe.lab_integration.molecular.rnaseq_import import Gene, ExpressionData, RNASeqExperiment
        ...
        # Compare experiments
        comparison = self.parser.compare_contrasts({"contrast1": exp1, "contrast2": exp2})
...
class TestIntegration:
    ...
    def test_full_rnaseq_workflow(self):
        ...
        pathway_terms = [
            PathwayTerm("PATH001", "Test Pathway 1", "Description 1", "TEST", 10, {"GENE001", "GENE002"}),
            PathwayTerm("PATH002", "Test Pathway 2", "Description 2", "TEST", 15, {"GENE003", "GENE004"})
        ]
        ...
        assert integration['statistics']['significant_genes'] == 2  # GENE001, GENE004 (padj <= 0.05)
        assert integration['statistics']['significant_pathways'] == 1  # Only one pathway with p_adj < 0.05
