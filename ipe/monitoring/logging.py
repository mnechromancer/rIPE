...
class LogConfig:
    ...
    sensitive_fields: list = field(default_factory=lambda: ['password', 'token', 'secret', 'key'])
...
class JSONFormatter(logging.Formatter):
    ...
    def _sanitize_value(self, value):
        ...
        if isinstance(value, dict):
            return {k: '[REDACTED]' if k.lower() in self.sensitive_fields else v 
                   for k, v in value.items()}
        elif isinstance(value, str) and any(field in value.lower() for field in self.sensitive_fields):
            return '[REDACTED]'
        return value
...
class SimulationLogger:
    ...
    def simulation_completed(self, simulation_id: str, duration: float, results: Dict[str, Any]):
    ...
    def generation_completed(self, simulation_id: str, generation: int, 
                           population_size: int, avg_fitness: float):
    ...
    def mutation_event(self, simulation_id: str, organism_id: str, 
                      mutation_type: str, effect: Dict[str, Any]):
        """Log mutation event."""
        self.logger.debug(
            "Mutation occurred",
            extra={
...
class APILogger:
    ...
    def request_received(self, method: str, path: str, headers: Dict[str, str], 
    ...
    def request_completed(self, request_id: str, status_code: int, 
    ...
    def authentication_event(self, event_type: str, user_id: Optional[str], 
...
class DatabaseLogger:
    ...
    def query_executed(self, query_type: str, table: str, duration: float, 
    ...
    def migration_event(self, migration_name: str, direction: str, 
    ...
    def backup_event(self, backup_type: str, success: bool, file_size: Optional[int] = None):
...
class SecurityLogger:
    ...
    def suspicious_activity(self, activity_type: str, ip_address: str, 
    ...
    def security_violation(self, violation_type: str, user_id: Optional[str], 
