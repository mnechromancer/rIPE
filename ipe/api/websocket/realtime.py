...
async def send_simulation_status_change(simulation_id: str, status: str, details: Dict[str, Any] = None):
...
async def websocket_health():
    ...
    return {
        ...
        "total_subscriptions": sum(len(subs) for subs in manager.simulation_subscribers.values()),
        "timestamp": datetime.now().isoformat()
    }
